...
{
    public class sqoExpedicaoBloqueioEstoqueMotivos: sqoClassProcessMovimentacao
    {
        private sqoClassSetMessageDefaults oClassSetMessageDefaults;
        private sqoClassBloqueioEstoqueMotivos oClassBloqueioEstoqueMotivos;
        ...
        private void Init(String sXmlDados, String sAction, String sUsuario)
        {
            ...
            this.oClassBloqueioEstoqueMotivos = new sqoClassBloqueioEstoqueMotivos();

            this.oClassBloqueioEstoqueMotivos = sqoClassBiblioSerDes.DeserializeObject<sqoClassBloqueioEstoqueMotivos>(sXmlDados);
        ...
        private void Validate()
        {
            ...
            {
                if (oClassBloqueioEstoqueMotivos.StatusMovimentacao != 1)
                {
                    this.nQtdErros++;
                ...
                if (String.IsNullOrEmpty(this.oClassBloqueioEstoqueMotivos.Observacao))
                {
                    this.nQtdErros++;
            ...
            {
                if (this.oClassBloqueioEstoqueMotivos.StatusMovimentacao != 3)
                {
                    this.nQtdErros++;
        ...
        private void ProcessBusinessLogic(sqoClassDbConnection oDBConnection)
        {
            ...
            try
            {
                ...
                long nIdMov = this.ExecuteStoreMovEstoqueUpdateStatus(
                    nStatusNovo
                    , sOrigemLancamento
                    , this.oClassBloqueioEstoqueMotivos.Local
                    , this.oClassBloqueioEstoqueMotivos.CodigoProduto
                    , this.oClassBloqueioEstoqueMotivos.QtdAtual
                    , this.oClassBloqueioEstoqueMotivos.CodigoRastreabilidade
                    , this.oClassBloqueioEstoqueMotivos.LocalOrigemMov
                    , this.oClassBloqueioEstoqueMotivos.StatusMovimentacao
                    );

                if (!String.IsNullOrEmpty(this.oClassBloqueioEstoqueMotivos.CodigoRastreabilidade))
                {
                    Volumes = sqoClassLESExpedicaoVolumeControlerDB.GetExpedicaoVolumesByOrdemProducao(this.oClassBloqueioEstoqueMotivos.CodigoRastreabilidade);
            ...
            , int nStatusAntigo)
        {
            using (var oCommand = new sqoCommand(CommandType.StoredProcedure))
            {
                oCommand
                    ...
                    .Add("@INFO_ORIGEM_LANCAMENTO", oClassBloqueioEstoqueMotivos.Motivo, OleDbType.VarChar, 50)
                    .Add("@INFO_ORIGEM_LANCAMENTO_2", nStatusNovo, OleDbType.VarChar, 50)
                    .Add("@OBSERVACAO", this.oClassBloqueioEstoqueMotivos.Observacao, OleDbType.VarChar, 500)
        ...
        private void ExecuteMMEstoqueSapEnvio(int nStatusNovo, long nIdMov, String sTipoMovimento)
        {
            using (var oCommand = new sqoCommand(CommandType.StoredProcedure))
            {
                oCommand
                    ...
                    .Add("@LOCAL", this.oClassBloqueioEstoqueMotivos.Local, OleDbType.VarChar, 50)
                    .Add("@CODIGO_PRODUTO", this.oClassBloqueioEstoqueMotivos.CodigoProduto, OleDbType.VarChar, 50)
                    ...
                    .Add("@UNIDADE_NEGOCIO", this.oClassBloqueioEstoqueMotivos.UnidadeNegocio, OleDbType.VarChar, 50)
                    .Add("@LOCAL_INTEGRACAO", this.oClassBloqueioEstoqueMotivos.LocalIntegracao, OleDbType.VarChar, 50)
                    .Add("@STATUS_MOVIMENTACAO", nStatusNovo, OleDbType.Integer)
                    .Add("@QUANTIDADE_LANCADA", this.oClassBloqueioEstoqueMotivos.QtdAtual, OleDbType.Double)
                    .Add("@CENTRO_CUSTOS", String.Empty, OleDbType.VarChar, 50)
                    .Add("@TIPO_INTEGRACAO_ERP", 0, OleDbType.Integer)
                    .Add("@LOCAL_ORIGEM", this.oClassBloqueioEstoqueMotivos.LocalOrigemMov, OleDbType.VarChar, 50)
                    .Add("@STATUS_MOVIMENTACAO_ORIGEM", this.oClassBloqueioEstoqueMotivos.StatusMovimentacao, OleDbType.Integer)
                    .Add("@CODIGO_RASTREABILIDADE", this.oClassBloqueioEstoqueMotivos.CodigoRastreabilidade, OleDbType.VarChar, 50)
                    ...
                    .Add("@UNIDADE_NEGOCIO_ORIGEM", this.oClassBloqueioEstoqueMotivos.UnidadeNegocio, OleDbType.VarChar, 50)
                    .Add("@LOCAL_ORIGEM_INTEGRACAO", this.oClassBloqueioEstoqueMotivos.LocalIntegracao, OleDbType.VarChar, 50)
        ...
        private void GetDataFillPersistence()
        {
            using (var oCommand = new sqoCommand(CommandType.Text))
            {
                oCommand
                    ...
                    .Add("@CODIGO", this.oClassBloqueioEstoqueMotivos.LocalOrigemMov, OleDbType.VarChar, 50)
                    ;
                ...
                try
                {
                    ...
                    this.oClassBloqueioEstoqueMotivos.UnidadeNegocio = oCommand.Command.Parameters["@UNIDADE_NEGOCIO"].Value.ToString();
                    this.oClassBloqueioEstoqueMotivos.LocalIntegracao = oCommand.Command.Parameters["@LOCAL_INTEGRACAO"].Value.ToString();
                }
                catch (Exception ex)
                {
                    throw new Exception(
    ...
    public class sqoClassBloqueioEstoqueMotivos
    {
