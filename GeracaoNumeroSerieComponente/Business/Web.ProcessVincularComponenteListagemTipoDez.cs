...
{
    [TemplateDebug("Web.ProcessVincularComponenteListagemTipoDez")]
    public class ProcessVincularComponenteListagemTipoDez : sqoClassProcessListar
    {
        ...
        public string ProcessBusinessLogic(sqoClassDbConnection oDBConnection)
        {
            ...
            sReturn = ListDocumentoReferenciaComponenteTipoDez();
        ...
        public string ListDocumentoReferenciaComponenteTipoDez()
        {
            string sReturn = null;
            ...
            {
                oDocumentoReferenciaListagemList = oVincularComponenteListagemDao.GetRastreabilidadeComponenteTipoDez(oDocumentoReferenciaListagem);
